...
instruction before terminating (i.e. $\simga.pc = \mathtt{exit}$). In the concurrent transition
...
identifier is pickt w.r.t. the security level of $i$. The program counter of the current thread
