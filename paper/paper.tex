...
\subsection{Observational Determinism for Concurrent Program Security}
...
they introduces system configurations which contain the list of threads the global
...
information the scheduler makes decisions. To cover probabilistic schedulers the
decision making of the scheduler and the execution of the program is probabilistic.
